  ...
  var MENU_DATA = [
    {
      ...
      children: [
        ...
        { label: 'The Team (coming soon)', href: '/about.html#team', disabled: true }
      ]
    },
    {
      label: 'Services', href: '/services.html',
      children: [
        { label: 'AC & Cooling',              href: '/ac-service.html' },
        { label: 'Engine & Transmission',     href: '/engine.html' },
        { label: 'Brakes & Suspension',       href: '/brakes.html' },
        { label: 'Tyres & Wheels',            href: '/tyres.html' },
        { label: 'Body & Exterior',           href: '/body.html' },
        { label: 'Battery & Electrical',      href: '/electrical.html' },
        { label: 'Hybrid & EV',               href: '/hybrid-ev.html' },
        { label: 'Pre-Purchase Inspection',   href: '/pre-purchase-inspection.html' },
    ...
    { label: '🔬 Free AI Diagnosis', href: '/diagnosis.html', cls: 'mob-diagnosis' },
    {
      ...
      children: [
        ...
        { label: 'Range Rover',   href: '/land-rover-repair-dubai.html' },
